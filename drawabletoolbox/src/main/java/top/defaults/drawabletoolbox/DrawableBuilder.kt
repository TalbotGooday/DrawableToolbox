...
class DrawableBuilder {
	...
	// <corner>
	fun cornerRadius(@Px cornerRadius: Int) = apply { properties.cornerRadius = cornerRadius }
	fun topLeftRadius(@Px topLeftRadius: Int) = apply { properties.topLeftRadius = topLeftRadius }
	fun topRightRadius(@Px topRightRadius: Int) = apply { properties.topRightRadius = topRightRadius }
	fun bottomRightRadius(@Px bottomRightRadius: Int) = apply { properties.bottomRightRadius = bottomRightRadius }
	fun bottomLeftRadius(@Px bottomLeftRadius: Int) = apply { properties.bottomLeftRadius = bottomLeftRadius }
	fun rounded() = apply { cornerRadius(Int.MAX_VALUE) }
	fun cornerRadii(
			@Px topLeftRadius: Int,
			@Px topRightRadius: Int,
			@Px bottomRightRadius: Int,
			@Px bottomLeftRadius: Int
	) = apply {
	...
	fun startColor(@ColorInt startColor: Int) = apply { properties.startColor = startColor }
	fun centerColor(@ColorInt centerColor: Int) = apply {
		properties.centerColor = centerColor
		useCenterColor(true)
	}

	fun endColor(@ColorInt endColor: Int) = apply { properties.endColor = endColor }
	fun gradientColors(@ColorInt startColor: Int, @ColorInt endColor: Int, @ColorInt centerColor: Int?) = apply {
	...
	fun gradientRadius(@Px radius: Float, type: Int) = apply { gradientRadius(radius); gradientRadiusType(type) }
	fun gradientRadiusInPixel(@Px radius: Float) = apply { gradientRadius(radius); gradientRadiusType(DrawableProperties.RADIUS_TYPE_PIXELS) }
	fun gradientRadiusInFraction(@Px radius: Float) = apply { gradientRadius(radius); gradientRadiusType(DrawableProperties.RADIUS_TYPE_FRACTION) }
	...
	// <size>
	fun width(@Px width: Int) = apply { properties.width = width }
	fun height(@Px height: Int) = apply { properties.height = height }
	fun size(@Px width: Int, @Px height: Int) = apply { width(width); height(height) }
	fun size(@Px size: Int) = apply { width(size).height(size) }

	// <solid>
	fun solidColor(@ColorInt solidColor: Int) = apply { properties.solidColor = solidColor }
    @ColorInt
    private var solidColorPressed: Int? = null
	fun solidColorPressed(@ColorInt color: Int?) = apply { solidColorPressed = color }
    @ColorInt
    private var solidColorPressedWhenRippleUnsupported: Int? = null
	fun solidColorPressedWhenRippleUnsupported(@ColorInt color: Int?) = apply { solidColorPressedWhenRippleUnsupported = color }
    @ColorInt
    private var solidColorDisabled: Int? = null
	fun solidColorDisabled(@ColorInt color: Int?) = apply { solidColorDisabled = color }
    @ColorInt
    private var solidColorSelected: Int? = null
	fun solidColorSelected(@ColorInt color: Int?) = apply { solidColorSelected = color }
	fun solidColorStateList(colorStateList: ColorStateList) = apply { properties.solidColorStateList = colorStateList }

	// <stroke>
	fun strokeWidth(@Px strokeWidth: Int) = apply { properties.strokeWidth = strokeWidth }

	fun strokeColor(@ColorInt strokeColor: Int) = apply { properties.strokeColor = strokeColor }
    @ColorInt
    private var strokeColorPressed: Int? = null
	fun strokeColorPressed(@ColorInt color: Int?) = apply { strokeColorPressed = color }
    @ColorInt
    private var strokeColorDisabled: Int? = null
	fun strokeColorDisabled(@ColorInt color: Int?) = apply { strokeColorDisabled = color }
    @ColorInt
    private var strokeColorSelected: Int? = null
	fun strokeColorSelected(@ColorInt color: Int?) = apply { strokeColorSelected = color }
	fun strokeColorStateList(colorStateList: ColorStateList) = apply { properties.strokeColorStateList = colorStateList }

	fun dashWidth(@Px dashWidth: Int) = apply { properties.dashWidth = dashWidth }
	...
	fun scaleWidth(@Px scale: Float) = apply { properties.scaleWidth = scale }
	fun scaleHeight(@Px scale: Float) = apply { properties.scaleHeight = scale }
	...
	fun rippleColor(@ColorInt color: Int) = apply { properties.rippleColor = color }
